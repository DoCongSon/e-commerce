...
const TopHeader = (props: TopHeaderProps) => (
    <div className="w-full bg-black">
        <div className="flex items-center relative justify-end w-full max-w-[1170px] mx-auto h-12 text-zinc-50">
            ...
            <div className="flex items-center cursor-pointer font-normal text-sm">
                <p>EngLish</p>
